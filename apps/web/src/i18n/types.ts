...
export interface Dict {
  ...
  /* Application Compiler panel (spec §11.4) — apps/web/src/features/application-compiler/ */
  'compiler.navLabel': string;
  'compiler.title': string;
  'compiler.description': string;
  'compiler.projectRootLabel': string;
  'compiler.projectRootPlaceholder': string;
  'compiler.load': string;
  'compiler.loadError': string;
  'compiler.targetsLabel': string;
  'compiler.targetsEmpty': string;
  'compiler.validation.pending': string;
  'compiler.validation.valid': string;
  'compiler.validation.invalid': string;
  'compiler.diagnosticsTitle': string;
  'compiler.planButton': string;
  'compiler.planError': string;
  'compiler.planHash': string;
  'compiler.planCreates': string;
  'compiler.planModifies': string;
  'compiler.planDeletes': string;
  'compiler.planReuses': string;
  'compiler.planConflicts': string;
  'compiler.planUnresolved': string;
  'compiler.planPermissions': string;
  'compiler.planVerification': string;
  'compiler.planNoVerification': string;
  'compiler.compileButton': string;
  'compiler.compileError': string;
  'compiler.cancelButton': string;
  'compiler.progressLabel': string;
  'compiler.phaseLabel': string;
  'compiler.phase.idle': string;
  'compiler.phase.validation': string;
  'compiler.phase.lowering': string;
  'compiler.phase.planning': string;
  'compiler.phase.write': string;
  'compiler.phase.verification': string;
  'compiler.status.queued': string;
  'compiler.status.validating': string;
  'compiler.status.lowering': string;
  ...
  'compiler.evidenceTitle': string;
  'compiler.evidence.planPath': string;
  'compiler.evidence.manifestPath': string;
  'compiler.evidence.evidencePath': string;
  'compiler.evidence.diagnosticsPath': string;
  'compiler.verification.passed': string;
  ...
  'compiler.conflictsTitle': string;
  'compiler.conflictsEmpty': string;
  'compiler.runIdLabel': string;
  'compiler.planStatus.succeeded': string;
  'compiler.planStatus.blocked': string;
  'compiler.planStatus.conflicted': string;
  'compiler.planStatus.failed-validation': string;
  'compiler.planStatus.failed-lowering': string;
  'compiler.planStatus.failed-planning': string;
}
