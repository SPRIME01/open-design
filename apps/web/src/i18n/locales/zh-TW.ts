...
export const zhTW: Dict = {
  ...
  "compiler.navLabel": "應用編譯器",
  "compiler.title": "應用編譯器",
  "compiler.description": "將應用 IR 編譯為可執行的目標產物。同一流程也可透過 CLI 的 `od app` 使用。",
  "compiler.projectRootLabel": "專案根目錄",
  "compiler.projectRootPlaceholder": "/絕對路徑/到/專案",
  "compiler.load": "載入",
  "compiler.loadError": "無法載入目標或驗證專案。",
  "compiler.targetsLabel": "目標",
  "compiler.targetsEmpty": "沒有可用目標。",
  "compiler.validation.pending": "尚未驗證",
  "compiler.validation.valid": "驗證通過",
  "compiler.validation.invalid": "驗證失敗",
  "compiler.diagnosticsTitle": "診斷({count})",
  "compiler.planButton": "產生計畫",
  "compiler.planError": "產生計畫失敗。",
  "compiler.planHash": "計畫雜湊",
  "compiler.planCreates": "新增",
  "compiler.planModifies": "修改",
  "compiler.planDeletes": "刪除",
  "compiler.planReuses": "複用",
  "compiler.planConflicts": "衝突",
  "compiler.planUnresolved": "未解析",
  "compiler.planPermissions": "所需權限",
  "compiler.planVerification": "計畫的驗證",
  "compiler.planNoVerification": "無",
  "compiler.compileButton": "編譯",
  "compiler.compileError": "無法啟動編譯執行。",
  "compiler.cancelButton": "取消",
  "compiler.progressLabel": "進度",
  "compiler.phaseLabel": "階段",
  "compiler.phase.idle": "閒置",
  "compiler.phase.validation": "驗證",
  "compiler.phase.lowering": "降級",
  "compiler.phase.planning": "規劃",
  "compiler.phase.write": "寫入",
  "compiler.phase.verification": "驗證",
  "compiler.status.queued": "排隊中",
  "compiler.status.validating": "驗證中",
  "compiler.status.lowering": "降級中",
  "compiler.status.planning": "規劃中",
  "compiler.status.writing": "寫入中",
  "compiler.status.verifying": "驗證中",
  "compiler.status.awaiting_approval": "等待核准",
  "compiler.status.succeeded": "已成功",
  "compiler.status.failed": "已失敗",
  "compiler.status.cancelled": "已取消",
  "compiler.evidenceTitle": "產生產物",
  "compiler.evidence.planPath": "計畫",
  "compiler.evidence.manifestPath": "清單",
  "compiler.evidence.evidencePath": "驗證證據",
  "compiler.evidence.diagnosticsPath": "診斷",
  "compiler.verification.passed": "驗證通過",
  "compiler.verification.failed": "驗證失敗",
  "compiler.approveButton": "核准計畫",
  "compiler.approvedNotice": "計畫已核准。",
  "compiler.awaitingApprovalNotice": "寫入前已暫停。請核准以下計畫雜湊:",
  "compiler.approveStale": "此計畫已不是最新版本。請重新產生計畫後再核准。",
  "compiler.replanButton": "重新產生計畫",
  "compiler.approveError": "核准失敗。",
  "compiler.conflictsTitle": "衝突",
  "compiler.conflictsEmpty": "無衝突。",
  "compiler.runIdLabel": "執行",
  "compiler.planStatus.succeeded": "計畫已產生",
  "compiler.planStatus.blocked": "已封鎖",
  "compiler.planStatus.conflicted": "存在衝突",
  "compiler.planStatus.failed-validation": "驗證失敗",
  "compiler.planStatus.failed-lowering": "降級失敗",
  "compiler.planStatus.failed-planning": "規劃失敗",
};
