...
export const fa: Dict = {
  ...
  "compiler.navLabel": "کامپایلر برنامه",
  "compiler.title": "کامپایلر برنامه",
  "compiler.description": "IR برنامه را به یک هدف قابل اجرا کامپایل می‌کند. همین جریان از طریق CLI با `od app` هم در دسترس است.",
  "compiler.projectRootLabel": "ریشه پروژه",
  "compiler.projectRootPlaceholder": "/مسیر/مطلق/پروژه",
  "compiler.load": "بارگذاری",
  "compiler.loadError": "بارگذاری هدف‌ها یا اعتبارسنجی پروژه ناموفق بود.",
  "compiler.targetsLabel": "هدف",
  "compiler.targetsEmpty": "هدفی در دسترس نیست.",
  "compiler.validation.pending": "اعتبارسنجی نشده",
  "compiler.validation.valid": "اعتبارسنجی موفق",
  "compiler.validation.invalid": "اعتبارسنجی ناموفق",
  "compiler.diagnosticsTitle": "تشخیص‌ها ({count})",
  "compiler.planButton": "ایجاد طرح",
  "compiler.planError": "برنامه‌ریزی ناموفق بود.",
  "compiler.planHash": "هش طرح",
  "compiler.planCreates": "ایجاد می‌کند",
  "compiler.planModifies": "تغییر می‌دهد",
  "compiler.planDeletes": "حذف می‌کند",
  "compiler.planReuses": "بازاستفاده می‌کند",
  "compiler.planConflicts": "تعارض‌ها",
  "compiler.planUnresolved": "حل‌نشده",
  "compiler.planPermissions": "مجوزهای لازم",
  "compiler.planVerification": "راستی‌آزمایی برنامه‌ریزی‌شده",
  "compiler.planNoVerification": "هیچ",
  "compiler.compileButton": "کامپایل",
  "compiler.compileError": "شروع اجرای کامپایل ممکن نشد.",
  "compiler.cancelButton": "لغو",
  "compiler.progressLabel": "پیشرفت",
  "compiler.phaseLabel": "مرحله",
  "compiler.phase.idle": "بی‌کار",
  "compiler.phase.validation": "اعتبارسنجی",
  "compiler.phase.lowering": "پایین‌سازی",
  "compiler.phase.planning": "برنامه‌ریزی",
  "compiler.phase.write": "نوشتن",
  "compiler.phase.verification": "راستی‌آزمایی",
  "compiler.status.queued": "در صف",
  "compiler.status.validating": "در حال اعتبارسنجی",
  "compiler.status.lowering": "در حال پایین‌سازی",
  "compiler.status.planning": "در حال برنامه‌ریزی",
  "compiler.status.writing": "در حال نوشتن",
  "compiler.status.verifying": "در حال راستی‌آزمایی",
  "compiler.status.awaiting_approval": "در انتظار تأیید",
  "compiler.status.succeeded": "موفق",
  "compiler.status.failed": "ناموفق",
  "compiler.status.cancelled": "لغو شد",
  "compiler.evidenceTitle": "خروجی تولیدشده",
  "compiler.evidence.planPath": "طرح",
  "compiler.evidence.manifestPath": "مانیفست",
  "compiler.evidence.evidencePath": "مدرک راستی‌آزمایی",
  "compiler.evidence.diagnosticsPath": "تشخیص‌ها",
  "compiler.verification.passed": "راستی‌آزمایی موفق",
  "compiler.verification.failed": "راستی‌آزمایی ناموفق",
  "compiler.approveButton": "تأیید طرح",
  "compiler.approvedNotice": "طرح تأیید شد.",
  "compiler.awaitingApprovalNotice": "قبل از نوشتن متوقف شد. هش برنامه را تأیید کنید:",
  "compiler.approveStale": "این طرح دیگر به‌روز نیست. طرح را دوباره بسازید و سپس تأیید کنید.",
  "compiler.replanButton": "ساخت دوباره طرح",
  "compiler.approveError": "تأیید ناموفق بود.",
  "compiler.conflictsTitle": "تعارض‌ها",
  "compiler.conflictsEmpty": "تعارضی نیست.",
  "compiler.runIdLabel": "اجرا",
  "compiler.planStatus.succeeded": "طرح ساخته شد",
  "compiler.planStatus.blocked": "مسدود",
  "compiler.planStatus.conflicted": "دارای تعارض",
  "compiler.planStatus.failed-validation": "اعتبارسنجی ناموفق",
  "compiler.planStatus.failed-lowering": "پایین‌سازی ناموفق",
  "compiler.planStatus.failed-planning": "برنامه‌ریزی ناموفق",
};
