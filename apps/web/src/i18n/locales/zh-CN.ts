...
export const zhCN: Dict = {
  ...
  "compiler.navLabel": "应用编译器",
  "compiler.title": "应用编译器",
  "compiler.description": "将应用 IR 编译为可运行的目标产物。同一流程也可通过 CLI 的 `od app` 使用。",
  "compiler.projectRootLabel": "项目根目录",
  "compiler.projectRootPlaceholder": "/绝对路径/到/项目",
  "compiler.load": "加载",
  "compiler.loadError": "无法加载目标或校验项目。",
  "compiler.targetsLabel": "目标",
  "compiler.targetsEmpty": "没有可用目标。",
  "compiler.validation.pending": "尚未校验",
  "compiler.validation.valid": "校验通过",
  "compiler.validation.invalid": "校验失败",
  "compiler.diagnosticsTitle": "诊断({count})",
  "compiler.planButton": "生成计划",
  "compiler.planError": "生成计划失败。",
  "compiler.planHash": "计划哈希",
  "compiler.planCreates": "新建",
  "compiler.planModifies": "修改",
  "compiler.planDeletes": "删除",
  "compiler.planReuses": "复用",
  "compiler.planConflicts": "冲突",
  "compiler.planUnresolved": "未解析",
  "compiler.planPermissions": "所需权限",
  "compiler.planVerification": "计划的验证",
  "compiler.planNoVerification": "无",
  "compiler.compileButton": "编译",
  "compiler.compileError": "无法启动编译运行。",
  "compiler.cancelButton": "取消",
  "compiler.progressLabel": "进度",
  "compiler.phaseLabel": "阶段",
  "compiler.phase.idle": "空闲",
  "compiler.phase.validation": "校验",
  "compiler.phase.lowering": "降级",
  "compiler.phase.planning": "规划",
  "compiler.phase.write": "写入",
  "compiler.phase.verification": "验证",
  "compiler.status.queued": "排队中",
  "compiler.status.validating": "校验中",
  "compiler.status.lowering": "降级中",
  "compiler.status.planning": "规划中",
  "compiler.status.writing": "写入中",
  "compiler.status.verifying": "验证中",
  "compiler.status.awaiting_approval": "等待审批",
  "compiler.status.succeeded": "已成功",
  "compiler.status.failed": "已失败",
  "compiler.status.cancelled": "已取消",
  "compiler.evidenceTitle": "生成产物",
  "compiler.evidence.planPath": "计划",
  "compiler.evidence.manifestPath": "清单",
  "compiler.evidence.evidencePath": "验证证据",
  "compiler.evidence.diagnosticsPath": "诊断",
  "compiler.verification.passed": "验证通过",
  "compiler.verification.failed": "验证失败",
  "compiler.approveButton": "批准计划",
  "compiler.approvedNotice": "计划已批准。",
  "compiler.awaitingApprovalNotice": "写入前已暂停。请审批以下计划哈希:",
  "compiler.approveStale": "该计划已不是最新版本。请重新生成计划后再批准。",
  "compiler.replanButton": "重新生成计划",
  "compiler.approveError": "批准失败。",
  "compiler.conflictsTitle": "冲突",
  "compiler.conflictsEmpty": "无冲突。",
  "compiler.runIdLabel": "运行",
  "compiler.planStatus.succeeded": "计划已生成",
  "compiler.planStatus.blocked": "已阻塞",
  "compiler.planStatus.conflicted": "存在冲突",
  "compiler.planStatus.failed-validation": "校验失败",
  "compiler.planStatus.failed-lowering": "降级失败",
  "compiler.planStatus.failed-planning": "规划失败",
};
