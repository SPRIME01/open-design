...
export const en: Dict = {
  ...
  "compiler.title": "Application Compiler",
  "compiler.description": "Compile an application IR into a runnable target. The same flow is available from the CLI as `od app`.",
  "compiler.projectRootLabel": "Project root",
  "compiler.projectRootPlaceholder": "/absolute/path/to/project",
  "compiler.load": "Load",
  "compiler.loadError": "Could not load targets or validate the project.",
  "compiler.targetsLabel": "Target",
  "compiler.targetsEmpty": "No targets available.",
  "compiler.validation.pending": "Not validated",
  "compiler.validation.valid": "Validation passed",
  "compiler.validation.invalid": "Validation failed",
  "compiler.diagnosticsTitle": "Diagnostics ({count})",
  "compiler.planButton": "Create plan",
  "compiler.planError": "Planning failed.",
  "compiler.planHash": "Plan hash",
  "compiler.planCreates": "Creates",
  "compiler.planModifies": "Modifies",
  "compiler.planDeletes": "Deletes",
  "compiler.planReuses": "Reuses",
  "compiler.planConflicts": "Conflicts",
  "compiler.planUnresolved": "Unresolved",
  "compiler.planPermissions": "Required permissions",
  "compiler.planVerification": "Verification planned",
  "compiler.planNoVerification": "None",
  "compiler.compileButton": "Compile",
  "compiler.compileError": "Could not start the compile run.",
  "compiler.cancelButton": "Cancel",
  "compiler.progressLabel": "Progress",
  "compiler.phaseLabel": "Phase",
  "compiler.phase.idle": "Idle",
  "compiler.phase.validation": "Validation",
  "compiler.phase.lowering": "Lowering",
  "compiler.phase.planning": "Planning",
  "compiler.phase.write": "Write",
  "compiler.phase.verification": "Verification",
  "compiler.status.queued": "Queued",
  "compiler.status.validating": "Validating",
  "compiler.status.lowering": "Lowering",
  "compiler.status.planning": "Planning",
  "compiler.status.writing": "Writing",
  "compiler.status.verifying": "Verifying",
  "compiler.status.awaiting_approval": "Awaiting approval",
  "compiler.status.succeeded": "Succeeded",
  "compiler.status.failed": "Failed",
  "compiler.status.cancelled": "Cancelled",
  "compiler.evidenceTitle": "Generated output",
  "compiler.evidence.planPath": "Plan",
  "compiler.evidence.manifestPath": "Manifest",
  "compiler.evidence.evidencePath": "Verification evidence",
  "compiler.evidence.diagnosticsPath": "Diagnostics",
  "compiler.verification.passed": "Verification passed",
  "compiler.verification.failed": "Verification failed",
  "compiler.approveButton": "Approve plan",
  "compiler.approvedNotice": "Plan approved.",
  "compiler.awaitingApprovalNotice": "Paused before writing. Approve plan hash:",
  "compiler.approveStale": "This plan is no longer current. Create the plan again, then approve.",
  "compiler.replanButton": "Create plan again",
  "compiler.approveError": "Approval failed.",
  "compiler.conflictsTitle": "Conflicts",
  "compiler.conflictsEmpty": "No conflicts.",
  "compiler.runIdLabel": "Run",
  "compiler.planStatus.succeeded": "Plan created",
  "compiler.planStatus.blocked": "Blocked",
  "compiler.planStatus.conflicted": "Conflicted",
  "compiler.planStatus.failed-validation": "Validation failed",
  "compiler.planStatus.failed-lowering": "Lowering failed",
  "compiler.planStatus.failed-planning": "Planning failed",
};
