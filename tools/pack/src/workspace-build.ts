...
export const WORKSPACE_BUILD_PACKAGES = [
  ...
  { directory: "packages/application-ir", name: "@open-design/application-ir" },
  { directory: "packages/application-compiler", name: "@open-design/application-compiler" },
  { directory: "packages/application-targets", name: "@open-design/application-targets" },
...
function workspaceBuildOutputFiles(config: ToolPackConfig): string[] {
  ...
  return [
    ...
    "packages/application-ir/dist/index.mjs",
    "packages/application-ir/dist/index.d.ts",
    "packages/application-compiler/dist/index.mjs",
    "packages/application-compiler/dist/index.d.ts",
    "packages/application-targets/dist/index.mjs",
    "packages/application-targets/dist/index.d.ts",
...
function workspaceBuildArtifacts(config: ToolPackConfig): WorkspaceBuildArtifact[] {
  const artifacts = [
    ...
    "packages/application-ir/dist",
    "packages/application-compiler/dist",
    "packages/application-targets/dist",
